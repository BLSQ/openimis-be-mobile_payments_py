...
DEFAULT_CFG = {
      ...
      "gql_query_payment_service_provider_perms":["208005"],
...
class MobilepaymentConfig(AppConfig):
    ...
    gql_query_payment_service_provider_perms =   []
    ...
    def _configure_perms(self, cfg):
          ...
          MobilepaymentConfig.gql_query_payment_service_provider_perms  = cfg["gql_query_payment_service_provider_perms"]
